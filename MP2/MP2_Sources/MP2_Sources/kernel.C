...
int main() {
    ...
    Console::puts("info frames needed = "); Console::puti(n_info_frames); Console::puts("\n"); 
    ...
    //process_mem_pool.mark_inaccessible(1024, 3);
    ...
    //Console::puts("++++++++Tests Starting++++++++\n");

    // test linked list trav ------------------------------------
    
    // test memory ----------------------------------------------
    
    
    Console::puts("++++++++++++++++++++ Test1 ++++++++++++++++++++\n");
    test_memory(&kernel_mem_pool, 40);
    
    Console::puts("++++++++++++++++++++ Test2 ++++++++++++++++++++\n");
    test_memory(&kernel_mem_pool, 20);

    Console::puts("++++++++++++++++++++ Test3 ++++++++++++++++++++\n");
    test_memory(&process_mem_pool, 100);

    Console::puts("++++++++++++++++++++ Test4 ++++++++++++++++++++\n");
    test_memory(&process_mem_pool, 120);

    Console::puts("++++++++++++++++++++ Test5 ++++++++++++++++++++\n");
    test_memory(&process_mem_pool, 5);

    Console::puts("++++++++++++++++++++ Test6 ++++++++++++++++++++\n");
    test_memory(&kernel_mem_pool, 2);
...
void test_memory(ContFramePool * _pool, unsigned int _allocs_to_go) {
    ...
    //Console::puts("Alloc = "); Console::puti(_allocs_to_go); Console::puts("=> ");
    ...
    if (_allocs_to_go > 0) {
        ...
        int n_frames = _allocs_to_go % 11 + 1;
    ...
    //Console::puts("Got till END => Will RELEASE now\n");;
